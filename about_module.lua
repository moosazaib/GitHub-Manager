...
function aboutModule.showAboutScreen(showMainScreen)
  ...
  step2.setText("Step 2: Viewing & Managing Your GitHub Profile\nTap 'My Profile' on the main menu to inspect your full GitHub account details. Here you can view your username, account type, display name, bio, location, public/private repository counts, public/private gists, followers, following, GitHub plan type, and account creation date. You can also edit your name, bio, and location directly from the app, or tap 'Manage Email Visibility' to easily switch your email between Public and Private status.")
  ...
  step5.setText("Step 5: Browsing & Managing Repository Files\nTap on any repository from your list to directly view its files and folders. Tap on any file to edit its text content, rename it, copy its raw URL, or delete it. You can navigate through sub-folders seamlessly using the back button.")
  ...
  step9.setText("Step 9: More Repository Options\nInside the 'More Options' menu of any repository, you can also copy direct repository links, copy ZIP archive links, rename your repository, switch visibility between Public and Private, or permanently delete the entire repository.")
